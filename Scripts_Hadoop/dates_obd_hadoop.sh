...
function overwrite_obd(){
    ...
    do
        ...
        hive -e "from ${operator}_obd_text insert overwrite table outlog_obd partition (operator='$operator',circle='$circle', monyear='$monyear', calldate='$year-$month-$day') select $col_list_out where circle='$circle' and monyear='$monyear' and call_date='$year-$month-$day'" >> $LOG
...
idea)
                ...
                col_list_out="msisdn,call_from_cli,appname,packname,null,null,status,subscription_status_code,wcflag,null,server_id,main_id,outdialer_id,null,central_app_id,call_initiate_time,call_start_time,call_end_time,call_duration,null,vendorname,device,pool,null,null,null,null,null,null,null,null,null,null,keypressed1,keypressed2,null,null,null,null,null,null,null,content_type_id,null,failure_isdn_reason_id,failure_reason_id,vcode,null,null,ivr_response_id,null,null,null,charging_rate_id"
                ;;
mts)
                operator="mts"
...
uninor)
                ...
                col_list_out="msisdn,call_from_cli,appname,packname,null,null,status,subscription_status_code,wcflag,baseresetflag,server_id,main_id,outdialer_id,null,central_app_id,call_initiate_time,call_start_time,call_end_time,call_duration,null,vendorname,device,pool,null,eup,langkey,null,null,null,null,null,null,null,keypressed1,keypressed2,null,param1,param2,param3,param4,param5,param6,content_type_id,null,failure_isdn_reason_id,failure_reason_id,vcode,null,null,null,song_selected,time_stamp,null,null"
                ;;
videocon)
                operator="videocon"
